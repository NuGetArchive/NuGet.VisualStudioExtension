...
function Test-InstallPackageAPI 
{
	...
	$p = New-ClassLibrary
	 ...
	 # Act
	[NuGet.VisualStudio.Implementation.APITest]::InstallPackageApi("owin","1.0.0") 
...
function Test-InstallPackageAsyncAPI
{
	...
	$p = New-ClassLibrary
	 ...
	 # Act
	[NuGet.VisualStudio.Implementation.APITest]::InstallPackageAsyncApi("owin","1.0.0") 
...
function Test-InstallPackageAPIEmptyVersion
{
	...
	$p = New-ClassLibrary
	 ...
	 # Act
	[NuGet.VisualStudio.Implementation.APITest]::InstallPackageApi("owin","") 
...
function Test-InstallPackageAPIBadSource
{
	...
	$p = New-ClassLibrary
	 ...
	 # Act&Assert
	Assert-Throws {[NuGet.VisualStudio.Implementation.APITest]::InstallPackageApiBadSource("owin","1.0.0") } "Exception calling `"InstallPackageApiBadSource`" with `"2`" argument(s): `"The remote name could not be resolved: 'packagesource'`""
    Assert-NoPackage $p "owin"	
}


function Test-InstallPackageAPINoSource
{
	param($context)
	...
	$p = New-ClassLibrary
	 ...
	 # Act
	[NuGet.VisualStudio.Implementation.APITest]::InstallPackageApiNoSource("owin","1.0.0") 
...
function Test-UninstallPackageAPI
{
	...
	$p = New-ClassLibrary
	 ...
	 # Act
	[NuGet.VisualStudio.Implementation.APITest]::InstallPackageApi("microsoft.owin","3.0.0")
	[NuGet.VisualStudio.Implementation.APITest]::UninstallPackageApi("microsoft.owin","true")
...
function Test-UninstallPackageAPINoDep
{
	...
	$p = New-ClassLibrary
	 ...
	 # Act
	[NuGet.VisualStudio.Implementation.APITest]::InstallPackageApi("microsoft.owin","3.0.0")
	[NuGet.VisualStudio.Implementation.APITest]::UninstallPackageApi("microsoft.owin",0)
...
function Test-UninstallPackageAPINoForce
{
	...
	$p = New-ClassLibrary
	 ...
	 # Act
	[NuGet.VisualStudio.Implementation.APITest]::InstallPackageApi("microsoft.owin","3.0.0")
	Assert-Throws { [NuGet.VisualStudio.Implementation.APITest]::UninstallPackageApi("owin","true") } "Exception calling `"UninstallPackageApi`" with `"2`" argument(s): `"Unable to uninstall 'Owin.1.0.0' because 'Microsoft.Owin.3.0.0' depends on it.`""
}
...
function Test-RestorePackageAPI
{
	...
	# Act
	[NuGet.VisualStudio.Implementation.APITest]::RestorePackageApi()
...
function Test-InstallPackageAPIPackageNotExist
{
	...
	# Act & Assert
	Assert-Throws { [NuGet.VisualStudio.Implementation.APITest]::InstallPackageApi("NotExistPackage","") } "Exception calling `"InstallPackageApi`" with `"2`" argument(s): `"No latest version found for the 'NotExistPackage' for the given source repositories and resolution context`""
...
function Test-InstallPackageAPIInstalledLowerVersionPackage
{
	...
	$p = New-ClassLibrary
	 ...
	 # Act
	[NuGet.VisualStudio.Implementation.APITest]::InstallPackageApi("microsoft.owin","2.0.0") 
	[NuGet.VisualStudio.Implementation.APITest]::InstallPackageApi("microsoft.owin","3.0.0") 
...
function Test-UninstallPackageAPIPackageNotExist
{
	...
	$projectName = $project.ProjectName
	 ...
	 # Act & Assert
	Assert-Throws {[NuGet.VisualStudio.Implementation.APITest]::UninstallPackageApi("owin","true") } "Exception calling `"UninstallPackageApi`" with `"2`" argument(s): `"Package 'owin' to be uninstalled could not be found in project '$projectName'`""
}
